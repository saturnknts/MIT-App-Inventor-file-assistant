...
$tab = GUICtrlCreateTab(-1, -1, 1,1);$guiw / 10, $guih / 10)
GUICtrlSetState(-1, $GUI_DISABLE)
...
$CopyButton1 = GUICtrlCreateButton("Copy", (($guiw * 0.720703125) / 2) - 165, 350, 330, 50, BitOR($BS_DEFPUSHBUTTON,$BS_MULTILINE));, $WS_EX_TRANSPARENT)
GUICtrlSetFont(-1, 14, 400, 0, "MS Sans Serif")
...
$ReNameButton = GUICtrlCreateButton("ReName", (($guiw * 0.720703125) / 2) - 165, 350, 330, 50, BitOR($BS_DEFPUSHBUTTON,$BS_MULTILINE))
GUICtrlSetFont(-1, 14, 400, 0, "MS Sans Serif")
...
Func Tab1() ;copy screens
	...
	$CopyButton1 = GUICtrlCreateButton("Copy", (($guiw * 0.720703125) / 2) - 165, 350, 330, 50, BitOR($BS_DEFPUSHBUTTON,$BS_MULTILINE));$BS_MULTILINE, $WS_EX_TRANSPARENT)
	GUICtrlSetFont(-1, 14, 400, 0, "MS Sans Serif")
	$Close = GUICtrlCreateButton("Close", (($guiw * 0.720703125) / 2) - 76, 425, 153, 33)
	GUICtrlCreateTabItem("")
